            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    <motion.div
                        ...
                        className="fixed inset-0 bg-white dark:bg-gray-900 z-40 flex flex-col items-center justify-center pt-20"
                    >
                        <StaggerContainer className="flex flex-col items-center gap-8 text-center">
                            {navLinks.map((link) => (
